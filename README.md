...
```bash
git clone https://github.com/Pradeeptalari14/tp-embedding-registry.git
cd tp-embedding-registry
```
...
```bash
kubectl port-forward deployment/tp-embedding-registry 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── registry_schema.sql     # Main configuration file
```
...
---
*Generated by [Embedding Registry Studio](https://pradeeptalari14.github.io/portfolio/tools/embedding-registry/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
